...
<p class="center">
<a href="/uploads/todo.icns"><img src="/uploads/todo.icns.png" alt="[Icon]" />
todo.icns</a>
</p>

<!--more-->

There is an official TextMate document icon template somewhere, but until I get an URL for that, here is the Photoshop <code>psd</code> I made from an existing icon: <a href="/uploads/textmate.icns.psd">textmate.icns.psd</a>.

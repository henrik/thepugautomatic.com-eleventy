...
comments: true
---
This is a multi-purpose post: a workaround for the poor icon handling in OS X and a pretty icon for my <a href="https://henrik.nyh.se/2007/08/tasks-bundle">Tasks bundle</a>.

<h4>Tasks bundle icon</h4>

I got tired of the generic blank document icon for my <a href="https://henrik.nyh.se/2007/08/tasks-bundle">Tasks bundle</a> <code>.todo</code> files, so I custom-made one:
...
Dragging-and-dropping an icon file to the excellent freeware app <a href="http://www.icons.cx/goodies/">icns2icon</a> (thanks, <a href="https://henrik.nyh.se/2007/08/os-x-icons#comment-45566">Andrew</a>!) makes it appear as its own info window icon, greatly simplifying things.

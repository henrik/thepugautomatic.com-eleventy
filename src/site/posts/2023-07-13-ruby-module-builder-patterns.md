...
In a more complex class with more and longer methods, it's still nice to be able to use `def` for most of it, with `define_method` oneliners only to store passed-in data.
